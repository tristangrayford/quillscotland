        ...
        <div className="goodreads">
            ...
            <div id="gr_author_widget_1699907161">
                ...
                <div id="goodreads-widget">
                    <div id="gr_header"><h1><a rel="nofollow" href="https://www.goodreads.com/book/show/55061225-whispers-to-a-crow">Goodreads reviews for Whispers to a Crow</a></h1></div>
                        <iframe title="the_iframe" src="https://www.goodreads.com/api/reviews_widget_iframe?did=DEVELOPER_ID&format=html&header_text=Goodreads+reviews+for+Whispers+to+a+Crow&isbn=1838485406&links=660&review_back=fff&stars=000&text=000" width="565" height="400"></iframe>
                    <div id="gr_footer">
                    <a className="gr_branding" target="_blank" rel="nofollow noopener noreferrer" href="https://www.goodreads.com/book/show/55061225-whispers-to-a-crow?utm_medium=api&utm_source=reviews_widget">Reviews from Goodreads.com</a>
                </div>
            </div>
        </div>
    )
