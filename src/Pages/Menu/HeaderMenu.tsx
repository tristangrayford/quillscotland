    ...
    public render(): JSX.Element {
        ...
        <div className="header-menu">
            ...
            <div className="social">
                <a target="_blank" rel="noreferrer" href="https://www.facebook.com/quillscotland">
                    <img src={Facebook} alt="Facebook" />
                </a>
                <a className="instagram" target="_blank" rel="noreferrer" href="https://www.instagram.com/quillscotland">
                    <img src={Instagram} alt="Instagram" />
                </a>
                <a target="_blank" rel="noreferrer" href="https://twitter.com/quillscotland">
                    <img src={Twitter} alt="Twitter" />
                </a>
                <a target="_blank" rel="noreferrer" href="https://bsky.app/profile/quill.scot">
                    <img src={Bluesky} alt="Bluesky" />
                </a>
                <a className="email" target="_blank" rel="noreferrer" href="mailto:info@quill.scot?subject=Website Contact">
