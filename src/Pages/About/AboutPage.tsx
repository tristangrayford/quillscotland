    ...
    return (<div className="App">
        ...
        <div className="about-page">
            <div className="half">
                ...
                <p>After years of searching to find the real spark behind his writing Scotland unlocked it - The rugged country and dark history, which also inspired the works of George R. Martin and Diana Gabaldon, gave new meaning to the fantasy tales of his childhood.</p>
